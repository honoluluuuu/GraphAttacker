...
while(attack_num<100):
    ...
    att_success = 0
    gcn_acc = 0
    save_dir = "result/PROTEINS_result-A-lr_c0.033-1.0-onehot0.txt"
    ...
    while (att_success == 0 and att_time < 10):
        ...
        adj_save = 'PROTEINS/adj_PROTEINS-A-lr_c0.033-1.0-onehot0/gen_PROTEINS_' + str(attack_graph) + '_' + str(att_time)
        ...
        while (epoch < FLAGS.epochs_gan):
            ...
            for c_epoch in range(FLAGS.epochs_c):
                ...
                out_cla = sess.run([Attgraph.C_op, Attgraph.C_loss, Attgraph.gen_adj_L, Attgraph.pre], feed_dict=Att_dict)
            ...
            if epoch > 1 and eval_c!=0:
                ...
                if acc_ori[2][0] == ori_class:
                    ...
                    if att_acc[0] ==0 and eval_c < graph_link * budget :
