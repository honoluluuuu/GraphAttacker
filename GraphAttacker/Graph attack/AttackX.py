...
while(attack_num<100):
    ...
    att_success = 0
    gcn_acc = 0
    save_dir = "result/PROTEINS_result-X-lr_c0.033-"+str(budget)+"-onehot.txt"
    ...
    while (att_success == 0 and att_time < 10):
        ...
        adj_save = 'PROTEINS/adj_PROTEINS-X-lr_c0.033-'+str(budget)+'-onehot/gen_PROTEINS_' + str(attack_graph) + '_' + str(att_time)
